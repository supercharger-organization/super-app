      ...
      this.board.lists.forEach(list => {
        ...
        switch(list.title.trim()) { 
          case "Geolocation": { 
            ...
            list.bsStartups = [
              new Startup(0, "Bluefox", "BlueFox technology senses mobile phones in real-time. Without having to download an app, opt-in or login, BlueFox helps businesses and brands sell more and engage with customers in any location, and in a privacy-friendly way.", null, null, null, null, null, null, null, null, null),
